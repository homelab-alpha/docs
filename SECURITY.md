...
This document outlines the security policy for the `docs` repository.
...
[https://github.com/homelab-alpha/docs/security/advisories/new]. Provide as many
details as possible, including reproduction steps and the potential impact.
...
[https://github.com/homelab-alpha/docs/security/advisories/new]: https://github.com/homelab-alpha/docs/security/advisories/new
