...
!(function (e, t) {
  ...
  function M(e, t, n, r, o, i, c, a) {
    ...
    if (("svg" === v && (o = !0), null != i))
      for (; y < i.length; y++)
        if (
          (u = i[y]) &&
          (u === e || (v ? u.localName == v : 3 == u.nodeType))
        ) {
          (e = u), (i[y] = null);
          break;
        }
        ...
        return zn(
          {
            ...
            onSubmit: function (i) {
              ...
              i.preventDefault(),
                t.onSubmit(
                  zn({ event: i, refresh: n, state: r.getState() }, o)
                ),
  ...
  function tr(e) {
    ...
    return !1 === n.isOpen || null === n.activeItemId
      ? null
      : (null === (t = Ft(n)) || void 0 === t ? void 0 : t.itemInputValue) ||
          null;
  }
  function nr(e) {
    return (
    ...
    return {
      ...
      set: function (e, t) {
        return Promise.resolve().then(function () {
          var i = o();
          return (
            (i[JSON.stringify(e)] = t), r().setItem(n, JSON.stringify(i)), t
          );
        });
      },
      delete: function (e) {
