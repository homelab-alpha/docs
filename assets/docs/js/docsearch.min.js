...
!(function (e, t) {
		...
		return (
			...
			(function (e, t) {
				...
				try {
					for (
						n = n.call(e);
						!(c = (r = n.next()).done) && (i.push(r.value), !t || i.length !== t);
						c = !0
					);
				} catch (e) {
					(a = !0), (o = e);
		...
		for (n.__k = [], s = 0; s < t.length; s++)
			if (
				...
				if (
					((m.__ = n),
					(m.__b = n.__b + 1),
					null === (p = _[s]) || (p && m.key == p.key && m.type === p.type))
				)
					_[s] = void 0;
				else
					for (f = 0; f < g; f++) {
						if ((p = _[f]) && m.key == p.key && m.type === p.type) {
							_[f] = void 0;
							break;
						}
						p = null;
	...
	function k(e, t, n) {
		...
		for (r = 0; r < e.__k.length; r++)
			(o = e.__k[r]) &&
				((o.__ = e),
				(t =
					'function' == typeof o.type ? k(o, t, n) : C(n, o, o, e.__k, o.__e, t)));
		return t;
	}
	function A(e, t) {
		return (
	...
	function x(e, t, n) {
		'-' === t[0]
			? e.setProperty(t, n)
			: (e[t] = null == n ? '' : 'number' != typeof n || y.test(t) ? n : n + 'px');
	}
	...
	function q(e, t, n, r, o, i, c, a, u) {
		...
		null != n.__h && ((u = n.__h), (a = t.__e = n.__e), (t.__h = null), (i = [a])),
			(l = s.__b) && l(t);
		try {
			e: if ('function' == typeof w) {
				if (
					((y = t.props),
					(_ = (l = w.contextType) && r[l.__c]),
					(g = l ? (_ ? _.props.value : l.__) : r),
					n.__c
						? (h = (f = t.__c = n.__c).__ = f.__E)
						: ('prototype' in w && w.prototype.render
								? (t.__c = f = new w(y, g))
								: ((t.__c = f = new j(y, g)), (f.constructor = w), (f.render = F)),
						  _ && _.sub(f),
						  (f.props = y),
						  f.state || (f.state = {}),
						  (f.context = g),
					...
					null != w.getDerivedStateFromProps &&
						...
						b(f.__s, w.getDerivedStateFromProps(y, f.__s))),
					(m = f.props),
					(v = f.state),
					p)
				)
				...
				(f.context = g),
					...
					p ||
						...
						(d = f.getSnapshotBeforeUpdate(m, v)),
					...
					h && (f.__E = f.__ = null),
					(f.__e = !1);
			} else null == i && t.__v === n.__v ? ((t.__k = n.__k), (t.__e = n.__e)) : (t.__e = M(n.__e, t, n, r, o, i, c, u));
			(l = s.diffed) && l(t);
		} catch (e) {
			(t.__v = null),
				(u || null != i) && ((t.__e = a), (t.__h = !!u), (i[i.indexOf(a)] = null)),
				s.__e(e, t, n);
		}
	}
	function L(e, t) {
	...
	function M(e, t, n, r, o, i, c, a) {
		...
		if (null === v) p === m || (a && e.data === m) || (e.data = m);
			...
			if (
				...
				for (y = i.length; y--; ) null != i[y] && _(i[y]);
			a ||
				('value' in m &&
					void 0 !== (y = m.value) &&
		...
		(t.componentWillUnmount = function () {
			...
			e.__v
				? (t.l ||
				  ...
				  B(g(Ee, { context: t.context }, e.__v), t.l))
	...
	function Ve() {
		return Be.createElement(
			'svg',
			{ width: '44', height: '15', className: 'DocSearch-Control-Key-Icon' },
			Be.createElement('path', {
				d: 'M2.118,11.5A1.519,1.519,0,0,1,1,11.042,1.583,1.583,0,0,1,1,8.815a1.519,1.519,0,0,1,1.113-.458h.715V6.643H2.118A1.519,1.519,0,0,1,1,6.185,1.519,1.519,0,0,1,.547,5.071,1.519,1.519,0,0,1,1,3.958,1.519,1.519,0,0,1,2.118,3.5a1.519,1.519,0,0,1,1.114.458A1.519,1.519,0,0,1,3.69,5.071v.715H5.4V5.071A1.564,1.564,0,0,1,6.976,3.5,1.564,1.564,0,0,1,8.547,5.071,1.564,1.564,0,0,1,6.976,6.643H6.261V8.357h.715a1.575,1.575,0,0,1,1.113,2.685,1.583,1.583,0,0,1-2.227,0A1.519,1.519,0,0,1,5.4,9.929V9.214H3.69v.715a1.519,1.519,0,0,1-.458,1.113A1.519,1.519,0,0,1,2.118,11.5Zm0-.857a.714.714,0,0,0,.715-.714V9.214H2.118a.715.715,0,1,0,0,1.429Zm4.858,0a.715.715,0,1,0,0-1.429H6.261v.715a.714.714,0,0,0,.715.714ZM3.69,8.357H5.4V6.643H3.69ZM2.118,5.786h.715V5.071a.714.714,0,0,0-.715-.714.715.715,0,0,0-.5,1.22A.686.686,0,0,0,2.118,5.786Zm4.143,0h.715a.715.715,0,0,0,.5-1.22.715.715,0,0,0-1.22.5Z',
				fill: 'currentColor',
			}),
			Be.createElement('path', {
				d: 'M12.4,11.475H11.344l3.879-7.95h1.056Z',
				fill: 'currentColor',
			}),
			Be.createElement('path', {
				d: 'M25.073,5.384l-.864.576a2.121,2.121,0,0,0-1.786-.923,2.207,2.207,0,0,0-2.266,2.326,2.206,2.206,0,0,0,2.266,2.325,2.1,2.1,0,0,0,1.782-.918l.84.617a3.108,3.108,0,0,1-2.622,1.293,3.217,3.217,0,0,1-3.349-3.317,3.217,3.217,0,0,1,3.349-3.317A3.046,3.046,0,0,1,25.073,5.384Z',
				fill: 'currentColor',
			}),
			Be.createElement('path', {
				d: 'M30.993,5.142h-2.07v5.419H27.891V5.142h-2.07V4.164h5.172Z',
				fill: 'currentColor',
			}),
			Be.createElement('path', {
				d: 'M34.67,4.164c1.471,0,2.266.658,2.266,1.851,0,1.087-.832,1.809-2.134,1.855l2.107,2.691h-1.28L33.591,7.87H33.07v2.691H32.038v-6.4Zm-1.6.969v1.8h1.572c.832,0,1.22-.3,1.22-.918s-.411-.882-1.22-.882Z',
				fill: 'currentColor',
			}),
			Be.createElement('path', {
				d: 'M42.883,10.561H38.31v-6.4h1.033V9.583h3.54Z',
				fill: 'currentColor',
			})
		);
	}
	function VDe() {
		return Be.createElement(
			'svg',
			{ width: '15', height: '15', className: 'DocSearch-Button-Key-Icon' },
			Be.createElement('path', {
				d: 'M3.193,7.971H2.576V10.7H1.542V4.3H2.576V6.993h.631L5.611,4.3H6.946L4.066,7.422,7.142,10.7h-1.4Z',
				fill: 'currentColor',
			})
		);
	}
		...
		return (
			oe(function () {
				'undefined' != typeof navigator &&
					(/(Mac|iPhone|iPod|iPad)/i.test(navigator.platform) ? f('⌘') : f(Ze));
			}, []),
			Be.createElement(
				'button',
				ze(
				...
				Be.createElement(
					...
					null !== s &&
						Be.createElement(
							...
							Be.createElement(
								'kbd',
								{ className: 'DocSearch-Command-Key' },
								s === Ze ? Be.createElement(Ve, null) : s
							),
							Be.createElement(
								'kbd',
								{ className: 'DocSearch-Button-Key' },
								s === Ze ? Be.createElement(VDe, null) : s
							)
						)
				)
			)
	...
	function rt(e, t) {
		if (e === t) return !0;
		if (nt(e) || nt(t) || 'function' == typeof e || 'function' == typeof t)
			return e === t;
				...
				if (null != n) {
					...
					try {
						if (((i = (n = n.call(e)).next), 0 === t)) {
							...
							for (
								;
								!(u = (r = i.call(n)).done) && (a.push(r.value), a.length !== t);
								u = !0
							);
					} catch (e) {
						(l = !0), (o = e);
	...
	var kt = '2.6.0',
		At = 'https://cdn.jsdelivr.net/npm/search-insights@'.concat(
			kt,
								...
								wt(
									n.map(function (e) {
										return It(
											...
											{},
											{
												algoliaSource: [].concat(wt(e.algoliaSource || []), [
			...
			l = Ge(function (e) {
				...
				if (t.isOpen) {
					...
					rt(
						...
						((u.current = n),
						n.length > 0 &&
							Ct({ onItemsChange: r, items: n, insights: a, state: t }));
				}
			}, 0);
		return {
				...
				{},
				{
					requests: e.queries.map(function (n) {
						return {
							query:
								'algolia' === e.requesterId
									? fn(fn({}, n), {}, { params: fn(fn({}, r), n.params) })
									: n,
							sourceId: t,
	...
	var gn = ['event', 'nextState', 'props', 'query', 'refresh', 'store'];
	function On(e, t) {
		var n = Object.keys(e);
		if (Object.getOwnPropertySymbols) {
			var r = Object.getOwnPropertySymbols(e);
				...
				o
					...
					.then(function (e) {
						return Promise.all(
							e.map(function (e) {
								return Promise.resolve(
									e.getItems(Sn({ query: i, refresh: c, state: a.getState() }, u))
								).then(function (t) {
		...
		switch (t.type) {
			...
			case 'blur':
				return t.props.debug
					? e
					: or(or({}, e), {}, { isOpen: !1, activeItemId: null });
			case 'mouseleave':
	...
	function fr(e) {
		var t = [],
			...
			r = zt(cr, n, function (e) {
				var t = e.prevState,
					r = e.state;
				n.onStateChange(
					lr({ prevState: t, state: r, refresh: c, navigator: n.navigator }, o)
				);
			}),
			o = (function (e) {
				var t = e.store;
		...
		return (
			...
			(function (e) {
				...
				metadata: er({ plugins: n.plugins, options: e }),
			...
			? Be.createElement(
					...
					Be.createElement(
						...
						e.collection.items.map(function (t, n) {
							return Be.createElement(
								Wr,
								Br({ key: [e.title, t.objectID].join(':'), item: t, index: n }, e)
							);
						})
					)
			  )
	...
	function Yr(e) {
		...
		return a && Zr.test(a) ? a.replace(Qr, '') : a;
	}
	function Gr() {
		return (
			(Gr =
						...
						renderIcon: function (e) {
							...
							return Be.createElement(
								...
								Be.createElement(
									...
									Be.createElement(Or, { type: r.type })
								)
							);
						},
			...
			function (e) {
				...
				return r.state.query
					? !1 === o
						? Be.createElement(
								xr,
								io({}, r, { translations: null == n ? void 0 : n.noResultsScreen })
						  )
			...
			: {
					get: function (e, r) {
						...
						return n.get(e, r, o).catch(function () {
							return _o({ caches: t }).get(e, r, o);
						});
					},
					set: function (e, r) {
						return n.set(e, r).catch(function () {
							return _o({ caches: t }).set(e, r);
						});
					},
					delete: function (e) {
						return n.delete(e).catch(function () {
							return _o({ caches: t }).delete(e);
						});
					},
					clear: function () {
						return n.clear().catch(function () {
							return _o({ caches: t }).clear();
						});
					},
			  };
	}
				...
				return Promise.all(
					n.map(function (n) {
						var o = n.params,
							...
							a = o.facetQuery,
							u = i(o, yo);
						return Wo(e)(n.indexName, {
							methods: { searchForFacetValues: Qo },
		...
		var o,
			i = {
				...
				logger:
					...
					{
						debug: function (e, t) {
							return Zo >= o && console.debug(e, t), Promise.resolve();
						},
						info: function (e, t) {
							return Yo >= o && console.info(e, t), Promise.resolve();
						},
						error: function (e, t) {
				...
				responsesCache: go(),
				requestsCache: go({ serializable: !1 }),
				hostsCache: _o({
					caches: [bo({ key: ''.concat(wo, '-').concat(e) }), go()],
				}),
			...
			t(
				...
				{},
				{
					methods: {
						...
						multipleQueries: Ko,
						multipleSearchForFacetValues: zo,
						initIndex: function (e) {
							return function (t) {
								return Wo(e)(t, {
									methods: {
										search: $o,
										searchForFacetValues: Qo,
										findAnswers: Jo,
									},
								});
							};
	...
	function li(e) {
		var t = e.appId,
			...
			W = (function (e, t, n) {
				return Be.useMemo(
					function () {
						var r = Xo(e, t);
						return (
							r.addAlgoliaAgent('docsearch', ei),
							!1 === /docsearch.js \(.*\)/.test(r.transporter.userAgent.value) &&
								r.addAlgoliaAgent('docsearch-react', ei),
							n(r)
						);
					},
					[e, t, n]
			...
			K = Be.useRef(
				ho({ key: '__DOCSEARCH_FAVORITE_SEARCHES__'.concat(r), limit: 10 })
			).current,
			z = Be.useRef(
				ho({
						...
						getSources: function (e) {
							...
							return W.search([
								...
								.then(function (e) {
									...
									i.context.searchSuggestions.length < Object.keys(v).length &&
										u({ searchSuggestions: Object.keys(v) }),
										u({ nbHits: m });
									var d = {};
									return (
										p &&
											(d = {
												...
												__autocomplete_queryID: o[0].queryID,
												__autocomplete_algoliaCredentials: { appId: t, apiKey: n },
											}),
										Object.values(v).map(function (e, t) {
											return {
													...
													return Object.values(
														...
														.map(function (e) {
															return e.map(function (t) {
																...
																return (
																	'lvl1' !== t.type && r && (n = r),
																	oi(oi({}, t), {}, { __docsearch_parent: n }, d)
																);
															});
														})
														.flat();
			...
			Be.createElement(
				...
				Be.createElement(
					...
					Be.createElement(
						...
						Be.createElement(vr, { translations: A })
					)
				)
			)
		);
	...
	function mi(e) {
		var t,
			n,
			r = Be.useRef(null),
			o = fi(Be.useState(!1), 2),
			i = o[0],
			c = o[1],
			a = fi(Be.useState((null == e ? void 0 : e.initialQuery) || void 0), 2),
			u = a[0],
			l = a[1],
			s = Be.useCallback(
				function () {
			...
			Be.createElement(
				...
				o({}, e, {
					transformSearchClient: function (t) {
						return (
							t.addAlgoliaAgent('docsearch.js', ei),
