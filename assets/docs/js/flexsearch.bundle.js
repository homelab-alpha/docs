...
(function _f(self) {
						...
						switch (this.G) {
							...
							case 'reverse':
								if (1 < e) {
									for (h = e - 1; 0 < h; h--)
										(g = l[h] + g),
											g.length >= this.B && M(this, n, g, L(q, d, r, e, h), a, c);
									g = '';
								}
							case 'forward':
								if (1 < e) {
	...
	function M(a, b, c, d, e, f, g) {
		...
		if (!b[c] || (g && !b[c][g]))
			a.s && (h = h[d]),
				...
				(f && h.includes(e)) ||
					((h[h.length] = e),
					a.m && ((a = a.register[e] || (a.register[e] = [])), (a[a.length] = h)));
	}
	...
	t.remove = function (a) {
		...
		if (this.register[a]) {
			for (
				var b = 0;
				b < this.h.length && (this.index[this.h[b]].remove(a, !this.o), !this.m);
				b++
			);
			if (this.I && !this.m)
				for (let c in this.l) {
