...
(function _f(self) {
  ...
  function ca(a, b) {
    ...
    if (
      ...
      (b && (a = E(a, b)),
      this.H && (a = E(a, this.H)),
      this.J && 1 < a.length && (a = E(a, this.J)),
      c || "" === c)
    ) {
      a = a.split(c);
      if (this.filter) {
        ...
        for (let r = 0; r < d; r++) {
          ...
          if (l && e >= this.B && (w || !n[l])) {
            ...
            switch (this.G) {
              ...
              default:
                if (
                  (this.C && (f = Math.min((f / this.C(b, l, r)) | 0, q - 1)),
                  M(this, n, l, f, a, c),
                  w && 1 < d && r < d - 1)
                )
                  for (
    ...
    if (!b[c] || (g && !b[c][g]))
      a.s && (h = h[d]),
        ...
        (f && h.includes(e)) ||
          ((h[h.length] = e),
          a.m &&
            ((a = a.register[e] || (a.register[e] = [])), (a[a.length] = h)));
  }
  t.search = function (a, b, c) {
    ...
    for (let n, w; c < e; c++) {
      w = a[c];
      h
        ? ((n = sa(this, d, f, b, g, 2 === e, w, m)),
          (f && !1 === n && d.length) || (m = w))
        : (n = sa(this, d, f, b, g, 1 === e, w));
      if (n) return n;
      if (f && c === e - 1) {
        k = d.length;
        if (!k) {
        ...
        if ((l = m[q]))
          if (
            ...
            e &&
              ...
              f &&
              ((p = l.length),
              p <= e ? ((e -= p), (l = null)) : ((l = l.slice(e)), (e = 0))),
            l && ((k[n++] = l), f && ((r += l.length), r >= d)))
          )
            break;
      if (n) {
  ...
  t.remove = function (a, b) {
    ...
    if (c) {
      if (this.m)
        ...
        N(this.map, a, this.D, this.s),
          this.depth && N(this.h, a, this.A, this.s);
      ...
      if (this.cache) {
        ...
        for (let d = 0, e, f; d < b.h.length; d++)
          (f = b.h[d]),
            (e = b.cache[f]),
            e.includes(a) && (b.h.splice(d--, 1), delete b.cache[f]);
      }
    }
    return this;
  };
  function N(a, b, c, d, e) {
    ...
    if (a.constructor === Array)
      if (e)
        ...
        for (let g = 0, h; g < e; g++)
          if ((h = a[g])) (f = N(h, b, c, d, e)), d || f || delete a[g];
      }
  ...
  function va(a) {
    ...
    switch (d) {
      case "init":
        ...
        d.cache = !1;
        b &&
          0 === b.indexOf("function") &&
          (d.encode = Function("return " + b)());
        a
      ...
      default:
        (a = a.id),
          (b = b[d].apply(b, c)),
          postMessage("search" === d ? { id: a, msg: b } : { id: a });
    }
  }
  let wa = 0;
  function O(a) {
  ...
  function Q(a) {
    ...
    for (let e = 0, f, g; e < d.length; e++)
      (f = d[e]),
        ...
        this.o && ((c[f] = new O(g)), c[f].o || (this.o = !1)),
        this.o || (c[f] = new K(g, this.register)),
        (this.K[e] = S(f, this.A)),
        (this.h[e] = f);
    if (this.C)
    ...
    if (b && (a || 0 === a)) {
      ...
      for (let d = 0, e, f; d < this.h.length; d++)
        (f = this.h[d]),
          (e = this.K[d]),
          x(e) && (e = [e]),
          V(b, e, this.A, 0, this.index[f], a, e[0], c);
      if (this.I) {
        let d = T(b, this.I),
          e = v();
        x(d) && (d = [d]);
  ...
  t.remove = function (a) {
    ...
    if (this.register[a]) {
      for (
        var b = 0;
        b < this.h.length &&
        (this.index[this.h[b]].remove(a, !this.o), !this.m);
        b++
      );
      if (this.I && !this.m)
        for (let c in this.l) {
  ...
  t.export = function (a, b, c, d, e) {
    ...
    if (d < this.h.length) {
      ...
      b = this;
      setTimeout(function () {
        g.export(a, b, e ? f : "", d, e++) ||
          (d++, (e = 1), b.export(a, b, f, d, e));
      });
    } else {
      let f, g;
      switch (e) {
  ...
  function Ha(a, b) {
    a &&
      ((a = Da.call(this, a).join(" ")),
      2 < a.length && (a = E(a, Ja)),
      b || (1 < a.length && (a = ha(a)), a && (a = a.split(" "))));
    return a || [];
  }
