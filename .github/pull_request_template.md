...
1. Carefully read each question in the pull request docs.
...
4. Do not remove the HTML comment tags, as this will break the Pull Request docs.
...
- [ ] 🔍 My code follows the [style guidelines](https://github.com/homelab-alpha/docs/blob/main/CODE_STYLE_AND_STANDARDS_GUIDES.md) of this project.
...
- [ ] ✍️ I have completed the [Author Self-Review Process](https://github.com/homelab-alpha/docs/blob/main/.github/review_process_template.md).
